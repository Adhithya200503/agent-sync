  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl lg:max-w-6xl">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Biogram Analytics</h1>
        <p className="text-muted-foreground">
          Comprehensive analytics for Biogram performance
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Information about your biogram and its configuration
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="p-2 bg-muted rounded-md text-sm">
                  {urlData.createdAt.toDate().toLocaleString()}
                </p>
              </div>
            </div>
          </div>
      ...
      <h2 className="text-2xl tracking-tight pt-4">Geographical Breakdown</h2>
      ...
      <h2 className="text-2xl tracking-tight pt-4">Technology Breakdown</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Browser Analytics */}
...
export default BioGramAnalytics;
